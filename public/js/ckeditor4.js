    ...
    $(document).ready(function()
    {
        if(typeof CKEDITOR != 'undefined')
        {
            ...
            $(".js-edit-trans-ckeditor4").each(function()
            {
                ...
                var config = 
                {
                    ...
                    filebrowserUploadUrl: $g_editTransUploadUrl, // The location of the script that handles file uploads. If set, the Upload tab will appear in the Link, Image, and Flash dialog windows.
